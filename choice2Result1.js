...
// currentScreen === "start"
function drawChoice2Result1() {
  // Background colour for the start screen
  background(bgChoice2Result1); // soft teal background
  ...
  text(
    "This card keeps me moving through the city. I always keep my eye on it.",
    width / 2 - 6,
    145,
    450,
  );
...
// ------------------------------------------------------------
// Called from main.js only when currentScreen === "choice2Result1"
function choice2Result1MousePressed() {
...
function choice2Result1KeyPressed() {
  if (key === "1") {
    currentScreen = "choice3";
  }
  if (keyCode === ESCAPE) {
